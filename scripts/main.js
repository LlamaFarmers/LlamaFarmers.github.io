...
document.getElementById("letter11button").addEventListener("click", function () {
	if(swapHelper == 0) {
		...
		swapHeperToo = letter11;
	} else {
	swapHeperToo.name = letter11.name;
...
document.getElementById("letter12button").addEventListener("click", function () {
	if(swapHelper == 0) {
		...
		swapHeperToo = letter12;
	} else {
	swapHeperToo.name = letter12.name;
...
document.getElementById("letter13button").addEventListener("click", function () {
	if(swapHelper == 0) {
		...
		swapHeperToo = letter13;
	} else {
	swapHeperToo.name = letter13.name;
