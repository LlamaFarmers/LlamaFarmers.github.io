...
document.getElementById("letter11button").addEventListener("click", function () {
	if (swapBucket1 == 0) {
		...
		document.getElementById("letter11button").style.backgroundColor = "aquamarine"
...
document.getElementById("letter12button").addEventListener("click", function () {
	if (swapBucket1 == 0) {
		...
		document.getElementById("letter12button").style.backgroundColor = "aquamarine"
...
document.getElementById("letter13button").addEventListener("click", function () {
	if (swapBucket1 == 0) {
		...
		document.getElementById("letter13button").style.backgroundColor = "aquamarine"
...
document.getElementById("letter21button").addEventListener("click", function () {
	if (swapBucket1 == 0) {
		...
		document.getElementById("letter21button").style.backgroundColor = "aquamarine"
...
document.getElementById("letter22button").addEventListener("click", function () {
	if (swapBucket1 == 0) {
		...
		document.getElementById("letter22button").style.backgroundColor = "aquamarine"
...
document.getElementById("letter23button").addEventListener("click", function () {
	if (swapBucket1 == 0) {
		...
		document.getElementById("letter23button").style.backgroundColor = "aquamarine"
...
document.getElementById("letter31button").addEventListener("click", function () {
	if (swapBucket1 == 0) {
		...
		document.getElementById("letter31button").style.backgroundColor = "aquamarine"
...
document.getElementById("letter32button").addEventListener("click", function () {
	if (swapBucket1 == 0) {
		...
		document.getElementById("letter32button").style.backgroundColor = "aquamarine"
...
document.getElementById("letter33button").addEventListener("click", function () {
	if (swapBucket1 == 0) {
		...
		document.getElementById("letter33button").style.backgroundColor = "aquamarine"
...
var column3Barcode;
var onOffState = "OFF";
document.getElementById("versionnumber").innerHTML = "version: 73.2";
