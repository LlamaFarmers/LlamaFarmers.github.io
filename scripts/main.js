...
document.getElementById("letter11button").addEventListener("click", function () {
	if(swapHelper == 0) {
		...
		swapHelperThree = "letter11button";
	...
	document.getElementById("letter11button").innerHTML = letter11.name;
	document.getElementById(swapHelperThree).innerHTML = swapHelperToo.name;
	swapHelper = 0;
	swapHelperToo = 0;
	document.getElementById("swappingtext").innerHTML = "Click on letters to swap them";
	}
...
document.getElementById("letter12button").addEventListener("click", function () {
	if(swapHelper == 0) {
		...
		swapHelperThree = "letter12button";
		document.getElementById("swappingtext").innerHTML = "Swapping " + swapHelper + " with...";
	} else {
...
document.getElementById("letter13button").addEventListener("click", function () {
	if(swapHelper == 0) {
		...
		swapHelperThree = "letter13button";
		document.getElementById("swappingtext").innerHTML = "Swapping " + swapHelper + " with...";
	} else {
...
var column3Barcode;
var onOffState = "OFF";
document.getElementById("versionnumber").innerHTML = "version: 54.7";
